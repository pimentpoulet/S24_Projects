...
/home/clement/anaconda3/envs/Pytorch_env_2/bin/python "/mnt/c/Clément PC_t/Code/Code/Python/PyTorch/ChatGPT/GPT-2/train_gpt2_no_ddp.py"

To run this code using wsl terminal:
goto /mnt/c/Clément PC_t/Code/Code/Python/PyTorch/ChatGPT/GPT-2
python train_gpt2_no_ddp.py

To run this code using ddp in wsl terinal
torchrun --standalone --nproc_per_node=1 train_gpt2_no_ddp.py
"""
...
assert total_batch_size % (B * T) == 0                    # 524288 % 8192 = 0
grad_accum_steps = total_batch_size // (B * T)            # 524288 // 8192 = 64 steps to complete 1 full batch
...
for step in range(max_steps):
    ...
    if ((step > 0 and step % 250 == 0) or last_step) and (not use_compile):    # evaluate generation
        ...
        for i in range(num_return_sequences):
            ...
            print(f"sample {i}: {decoded}")           # print generated text
